...
\section{Learning to Segment Repetitive Sequences}\label{sec:art-seg}
...
\chapter{Segmented Exercise Classification}\label{chp:segment-class}
...
Section~\ref{sec:collapsed-sampler}. The MAP sampled assignment is used to produce a point estimate of the parameters.
...
\begin{table}[ht]
    ...
    \end{tabular}
    \caption{Segment classification performance of different classifiers.}
...
\begin{table}[ht]
    ...
    MoHMM               & 0.829               & 0.799              & 0.790          & 0.81               & \textbf{0.829} \\
    \end{tabular}
    \caption{Segment classification performance including the \emph{rest} class. 
...
The strong performing baseline classifier from Chapter~\ref{chp:segment-class} has the disadvantage 
that it requires ground truth segmentations. In contrast the \ac{CHMM} system presented for segmentation
in Section~\ref{sec:art-seg} can perform this segmentation in an unsupervised manner. Doing so simply
requires inspection of the latent state sequences. Portions of the sequence corresponding to the 

\begin{figure}[t!]
    \centering
    \includegraphics[width=1\textwidth]{img/segmentation/alt_db_bicep_curl.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=1\textwidth]{img/segmentation/jumping_jacks.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=1\textwidth]{img/segmentation/burpee.pdf}
    \caption{Burpees.}
    \label{fig:tmp3}
\end{figure}
