...
\end{itemize}
A variety of features, $\phi(w_i)$, have been proposed in the literature.
The most common are described below. For ease of exposition the input will be assumed
to be a one dimensional real valued time series and the features computed over the
first window spanning from time $1$ to $n$. Generalization to multiple dimensions and
other window size and positions is straightforward.
\begin{align*}
