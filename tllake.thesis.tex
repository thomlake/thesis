...
structural relationships amongst variables and controls the ways in which they may interact.
...
\begin{quote}
    Chapter~\ref{chap:Infering Exercise Types and Variations} presents experiments
    using Bayesian nonparametrics to cluster exercises and exercise variations.
\end{quote}
...
results are only presented for discrimination amongst 13 different
...
former being a binary classifier and the later being a mult-class classifier. The classifier used
...
\chapter{Infering Exercise Types and Variations}
\label{chap:Infering Exercise Types and Variations}
...
\section{Clustering Exercise Types}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/clustering.types/cluster-ami.pdf}
    \caption{Burpees.}
    \label{fig:cluster-type-ami}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Burpees.}
    \label{fig:cluster-confustion}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{img/clustering.types/cluster-confusion.pdf}
    \caption{Burpees.}
    \label{fig:cluster-confustion}
\end{figure}


\section{Clustering Exercise Variations}
...
If the end goal is classification, splitting classes into subclasses can potentially
increase classifier accuracy due to a reduction in intra-class variability.
